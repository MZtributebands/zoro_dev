...
namespace Stc\AppBundle\Model\Generator;

use Stc\AppBundle\Entity\Contract;
use Stc\AppBundle\Model\VariableModel\AbstractVariableModel;
...
class ContractGenerator
{
    ...
    {
        $this->template = 'StcAppBundle:ContractTemplate:' . strtolower($this->contract->getContractType()) . '.html.twig';
        $varModel = 'Stc\AppBundle\Model\VariableModel\\'.ucfirst(strtolower
            ($this->contract->getContractType())) . 'VariableModel';
