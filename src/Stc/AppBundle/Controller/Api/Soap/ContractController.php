...
class ContractController extends SoapController
{
    /**
     * @Soap\Method("getContracts")
     * @Soap\Param("page", phpType="int")
     * @Soap\Param("limit", phpType="int")
     * @Soap\Param("order", phpType="string")
     * @Soap\Result(phpType="Stc\AppBundle\Entity\ContractSoap[]")
    ...
    /**
     * @Soap\Method("createContract")
     * @Soap\Param("case", phpType="Stc\AppBundle\Entity\ContractSoap")
