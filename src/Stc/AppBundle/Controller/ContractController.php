...
use Stc\AppBundle\Form\Type\ContractType;
use Stc\AppBundle\Form\Builder\ContractCustomizerBuilder;
...
class ContractController extends Controller
{
    ...
    /**
     * @Route("/info/{id}", name="stc_contract_info", requirements={"id"="\d+"})
     * @Template("StcAppBundle:Contract:view.html.twig")
     * @AclAncestor("stc_contract_view")
     */
    public function infoViewAction(Contract $contract)
    {
     ...
     * @Template("StcAppBundle:Contract:update.html.twig")
     * @Acl(
    ...
    public function generate()
    {
        ...
        $contractRepository = $this->getDoctrine()->getManager()->getRepository('StcAppBundle:Contract');
...
//print_r($resultArray);exit;
    ...
    /**
     * @Route("/show/{id}", name="stc_contract_show", requirements={"id"="\d+"})
     * @Template
     * @Acl(
     * id="stc_contract_show",
     * type="entity",
     * class="StcAppBundle:Contract",
     * permission="VIEW"
     * )
     */
    public function showAction(Contract $contract=null)
    {
        if ($contract === null) {
            $contract_id = $this->getRequest()->get('id');
            $contractRepository = $this->getDoctrine()->getManager()->getRepository('StcAppBundle:Contract');
            $contract = $contractRepository->find($contract_id);
        }
